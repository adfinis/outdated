# Generated by Django 3.2.18 on 2023-04-14 13:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='project',
            constraint=models.UniqueConstraint(condition=models.Q(('name__iexact', django.db.models.functions.text.Lower('name'))), fields=('name',), name='unique_project_name'),
        ),
        migrations.AddIndex(
            model_name='dependencyversion',
            index=models.Index(fields=['dependency', 'version'], name='dependency_version_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='dependencyversion',
